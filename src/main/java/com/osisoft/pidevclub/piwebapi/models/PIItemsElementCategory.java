...
public class PIItemsElementCategory {
	...
	private List<PIElementCategory> items = null;
	...
	public void setItems(List<PIElementCategory> items) { this.items = items;}

	public List<PIElementCategory> getItems() { return this.items;}
