...
public class PIEnumerationSet {
	...
	private PIEnumerationSetLinks links = null;
	...
	public void setLinks(PIEnumerationSetLinks links) { this.links = links;}

	public PIEnumerationSetLinks getLinks() { return this.links;}
