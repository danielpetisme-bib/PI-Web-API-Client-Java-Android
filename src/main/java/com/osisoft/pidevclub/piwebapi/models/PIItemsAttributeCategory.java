...
public class PIItemsAttributeCategory {
	...
	private List<PIAttributeCategory> items = null;
	...
	public void setItems(List<PIAttributeCategory> items) { this.items = items;}

	public List<PIAttributeCategory> getItems() { return this.items;}
