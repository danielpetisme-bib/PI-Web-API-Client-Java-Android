...
public class PIItemsItemEventFrame {
	...
	private List<PIItemEventFrame> items = null;
	...
	public void setItems(List<PIItemEventFrame> items) { this.items = items;}

	public List<PIItemEventFrame> getItems() { return this.items;}
