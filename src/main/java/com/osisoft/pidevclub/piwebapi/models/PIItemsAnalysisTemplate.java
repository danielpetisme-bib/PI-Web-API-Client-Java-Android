...
public class PIItemsAnalysisTemplate {
	...
	private List<PIAnalysisTemplate> items = null;
	...
	public void setItems(List<PIAnalysisTemplate> items) { this.items = items;}

	public List<PIAnalysisTemplate> getItems() { return this.items;}
