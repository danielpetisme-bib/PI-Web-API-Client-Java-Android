...
public class PIAssetDatabase {
	...
	private PIAssetDatabaseLinks links = null;
	...
	public void setLinks(PIAssetDatabaseLinks links) { this.links = links;}

	public PIAssetDatabaseLinks getLinks() { return this.links;}
