...
public class PIItemsAnalysisRulePlugIn {
	...
	private List<PIAnalysisRulePlugIn> items = null;
	...
	public void setItems(List<PIAnalysisRulePlugIn> items) { this.items = items;}

	public List<PIAnalysisRulePlugIn> getItems() { return this.items;}
