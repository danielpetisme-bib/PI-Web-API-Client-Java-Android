...
public class PIAttributeTrait {
	...
	private PIAttributeTraitLinks links = null;
	...
	public void setLinks(PIAttributeTraitLinks links) { this.links = links;}

	public PIAttributeTraitLinks getLinks() { return this.links;}
