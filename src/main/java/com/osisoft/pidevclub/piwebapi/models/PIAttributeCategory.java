...
public class PIAttributeCategory {
	...
	private PIAttributeCategoryLinks links = null;
	...
	public void setLinks(PIAttributeCategoryLinks links) { this.links = links;}

	public PIAttributeCategoryLinks getLinks() { return this.links;}
