...
public class PIItemsAssetDatabase {
	...
	private List<PIAssetDatabase> items = null;
	...
	public void setItems(List<PIAssetDatabase> items) { this.items = items;}

	public List<PIAssetDatabase> getItems() { return this.items;}
