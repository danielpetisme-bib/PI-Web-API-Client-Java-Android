...
public class PIItemsTableCategory {
	...
	private List<PITableCategory> items = null;
	...
	public void setItems(List<PITableCategory> items) { this.items = items;}

	public List<PITableCategory> getItems() { return this.items;}
