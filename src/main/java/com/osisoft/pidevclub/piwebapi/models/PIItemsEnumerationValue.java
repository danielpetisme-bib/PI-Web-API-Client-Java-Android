...
public class PIItemsEnumerationValue {
	...
	private List<PIEnumerationValue> items = null;
	...
	public void setItems(List<PIEnumerationValue> items) { this.items = items;}

	public List<PIEnumerationValue> getItems() { return this.items;}
