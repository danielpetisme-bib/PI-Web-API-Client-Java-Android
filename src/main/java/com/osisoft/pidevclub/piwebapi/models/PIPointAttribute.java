...
public class PIPointAttribute {
	...
	private PIPointAttributeLinks links = null;
	...
	public void setLinks(PIPointAttributeLinks links) { this.links = links;}

	public PIPointAttributeLinks getLinks() { return this.links;}
