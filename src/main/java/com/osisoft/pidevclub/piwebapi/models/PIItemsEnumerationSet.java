...
public class PIItemsEnumerationSet {
	...
	private List<PIEnumerationSet> items = null;
	...
	public void setItems(List<PIEnumerationSet> items) { this.items = items;}

	public List<PIEnumerationSet> getItems() { return this.items;}
