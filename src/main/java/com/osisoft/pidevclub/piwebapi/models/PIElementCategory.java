...
public class PIElementCategory {
	...
	private PIElementCategoryLinks links = null;
	...
	public void setLinks(PIElementCategoryLinks links) { this.links = links;}

	public PIElementCategoryLinks getLinks() { return this.links;}
