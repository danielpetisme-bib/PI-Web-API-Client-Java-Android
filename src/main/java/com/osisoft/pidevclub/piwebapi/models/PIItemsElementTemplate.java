...
public class PIItemsElementTemplate {
	...
	private List<PIElementTemplate> items = null;
	...
	public void setItems(List<PIElementTemplate> items) { this.items = items;}

	public List<PIElementTemplate> getItems() { return this.items;}
