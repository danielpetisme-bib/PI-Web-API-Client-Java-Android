...
public class PIItemsSecurityIdentity {
	...
	private List<PISecurityIdentity> items = null;
	...
	public void setItems(List<PISecurityIdentity> items) { this.items = items;}

	public List<PISecurityIdentity> getItems() { return this.items;}
