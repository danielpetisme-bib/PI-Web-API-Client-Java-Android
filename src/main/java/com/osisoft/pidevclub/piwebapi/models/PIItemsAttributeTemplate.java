...
public class PIItemsAttributeTemplate {
	...
	private List<PIAttributeTemplate> items = null;
	...
	public void setItems(List<PIAttributeTemplate> items) { this.items = items;}

	public List<PIAttributeTemplate> getItems() { return this.items;}
