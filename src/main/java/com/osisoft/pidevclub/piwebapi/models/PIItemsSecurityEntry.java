...
public class PIItemsSecurityEntry {
	...
	private List<PISecurityEntry> items = null;
	...
	public void setItems(List<PISecurityEntry> items) { this.items = items;}

	public List<PISecurityEntry> getItems() { return this.items;}
