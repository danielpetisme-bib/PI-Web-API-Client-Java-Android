...
public class PIItemsChannelInstance {
	...
	private List<PIChannelInstance> items = null;
	...
	public void setItems(List<PIChannelInstance> items) { this.items = items;}

	public List<PIChannelInstance> getItems() { return this.items;}
