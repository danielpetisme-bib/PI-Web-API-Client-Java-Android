...
public class DataServerApi {
	 ...
	 *
	 */
	public PIItemsDataServer list(String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PIItemsDataServer> resp = listWithHttpInfo(selectedFields, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve a list of Data Servers known to this service. (with HTTP information)
	 *
	 */
	public ApiResponse<PIItemsDataServer> listWithHttpInfo(String selectedFields, String webIdType) throws ApiException {
		okhttp3.Call call = listCall(selectedFields, webIdType,null,null);
		Type localVarReturnType = new TypeToken<PIItemsDataServer>(){}.getType();
	 ...
	 *
	 */
	public okhttp3.Call listAsync(String selectedFields, String webIdType, final ApiCallback<PIItemsDataServer> callback) throws ApiException {
	 ...
	 *
	 */
	public PIDataServer getByName(String name, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PIDataServer> resp = getByNameWithHttpInfo(name, selectedFields, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve a Data Server by name. (with HTTP information)
	 *
	 */
	public ApiResponse<PIDataServer> getByNameWithHttpInfo(String name, String selectedFields, String webIdType) throws ApiException {
		okhttp3.Call call = getByNameCall(name, selectedFields, webIdType,null,null);
		Type localVarReturnType = new TypeToken<PIDataServer>(){}.getType();
		return apiClient.execute(call, localVarReturnType);
	}
	 ...
	 *
	 */
	public okhttp3.Call getByNameAsync(String name, String selectedFields, String webIdType, final ApiCallback<PIDataServer> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	 ...
	 *
	 */
	public PIDataServer getByPath(String path, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PIDataServer> resp = getByPathWithHttpInfo(path, selectedFields, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve a Data Server by path. (with HTTP information)
	 *
	 */
	public ApiResponse<PIDataServer> getByPathWithHttpInfo(String path, String selectedFields, String webIdType) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getByPathAsync(String path, String selectedFields, String webIdType, final ApiCallback<PIDataServer> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	 ...
	 *
	 */
	public PIDataServer get(String webId, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PIDataServer> resp = getWithHttpInfo(webId, selectedFields, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve a Data Server. (with HTTP information)
	 *
	 */
	public ApiResponse<PIDataServer> getWithHttpInfo(String webId, String selectedFields, String webIdType) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getAsync(String webId, String selectedFields, String webIdType, final ApiCallback<PIDataServer> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	...
	/**
	 * Retrieve enumeration sets for given Data Server. (with HTTP information)
	 *
	 */
	...
	/**
	 * Create an enumeration set on the Data Server. (with HTTP information)
	 *
	 */
	 ...
	 *
	 */
	public PIDataServerLicense getLicense(String webId, String module, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PIDataServerLicense> resp = getLicenseWithHttpInfo(webId, module, selectedFields, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieves the specified license for the given Data Server. The fields of the response object are string representations of the numerical values reported by the Data Server, with "Infinity" representing a license field with no limit. (with HTTP information)
	 *
	 */
	public ApiResponse<PIDataServerLicense> getLicenseWithHttpInfo(String webId, String module, String selectedFields, String webIdType) throws ApiException {
		okhttp3.Call call = getLicenseCall(webId, module, selectedFields, webIdType,null,null);
		Type localVarReturnType = new TypeToken<PIDataServerLicense>(){}.getType();
		return apiClient.execute(call, localVarReturnType);
	}
	 ...
	 *
	 */
	public okhttp3.Call getLicenseAsync(String webId, String module, String selectedFields, String webIdType, final ApiCallback<PIDataServerLicense> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
		...
		okhttp3.Call call = getLicenseCall(webId, module, selectedFields, webIdType, progressListener, progressRequestListener);
		apiClient.executeAsync(call, callback);
		return call;
	}

	private okhttp3.Call getLicenseCall(String webId, String module, String selectedFields, String webIdType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		// verify the required parameter 'webId' is set
		if (webId == null)
			throw new ApiException("Missing required parameter 'webId'");
		...
		localVarPath = localVarPath.replaceAll("\\{webId\\}", apiClient.escapeString(webId.toString()));
		if (module != null)
			localVarQueryParams.addAll(apiClient.parameterToPairs("multi", "module", module));
		if (selectedFields != null)
			localVarQueryParams.addAll(apiClient.parameterToPairs("multi", "selectedFields", selectedFields));
		if (webIdType != null)
			localVarQueryParams.addAll(apiClient.parameterToPairs("multi", "webIdType", webIdType));
	 ...
	 *
	 */
	public PIItemsPoint getPoints(String webId, Integer maxCount, String nameFilter, String selectedFields, Integer startIndex, String webIdType) throws ApiException {
		ApiResponse<PIItemsPoint> resp = getPointsWithHttpInfo(webId, maxCount, nameFilter, selectedFields, startIndex, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve a list of points on a specified Data Server. (with HTTP information)
	 *
	 */
	public ApiResponse<PIItemsPoint> getPointsWithHttpInfo(String webId, Integer maxCount, String nameFilter, String selectedFields, Integer startIndex, String webIdType) throws ApiException {
		okhttp3.Call call = getPointsCall(webId, maxCount, nameFilter, selectedFields, startIndex, webIdType,null,null);
		Type localVarReturnType = new TypeToken<PIItemsPoint>(){}.getType();
		return apiClient.execute(call, localVarReturnType);
	}
	 ...
	 *
	 */
	public okhttp3.Call getPointsAsync(String webId, Integer maxCount, String nameFilter, String selectedFields, Integer startIndex, String webIdType, final ApiCallback<PIItemsPoint> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
		...
		okhttp3.Call call = getPointsCall(webId, maxCount, nameFilter, selectedFields, startIndex, webIdType, progressListener, progressRequestListener);
		apiClient.executeAsync(call, callback);
		return call;
	}

	private okhttp3.Call getPointsCall(String webId, Integer maxCount, String nameFilter, String selectedFields, Integer startIndex, String webIdType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		// verify the required parameter 'webId' is set
		if (webId == null)
			throw new ApiException("Missing required parameter 'webId'");
	 ...
	 *
	 */
	public void createPoint(String webId, PIPoint pointDTO, String webIdType) throws ApiException {
		createPointWithHttpInfo(webId, pointDTO, webIdType);
	}

	/**
	 * Create a point in the specified Data Server. (with HTTP information)
	 *
	 */
	public ApiResponse<Void> createPointWithHttpInfo(String webId, PIPoint pointDTO, String webIdType) throws ApiException {
		okhttp3.Call call = createPointCall(webId, pointDTO, webIdType,null,null);
		return apiClient.execute(call);
	}
	 ...
	 *
	 */
	public okhttp3.Call createPointAsync(String webId, PIPoint pointDTO, String webIdType, final ApiCallback<Void> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
		...
		okhttp3.Call call = createPointCall(webId, pointDTO, webIdType, progressListener, progressRequestListener);
		apiClient.executeAsync(call, callback);
		return call;
	}

	private okhttp3.Call createPointCall(String webId, PIPoint pointDTO, String webIdType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		// verify the required parameter 'webId' is set
		if (webId == null)
			throw new ApiException("Missing required parameter 'webId'");
