...
public class DataServerApi {
	 ...
	 *
	 */
	public PIItemsDataServer list(String selectedFields) throws ApiException {
		ApiResponse<PIItemsDataServer> resp = listWithHttpInfo(selectedFields);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PIItemsDataServer> listWithHttpInfo(String selectedFields) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call listAsync(String selectedFields, final ApiCallback<PIItemsDataServer> callback) throws ApiException {
	 ...
	 *
	 */
	public PIDataServer getByName(String name, String selectedFields) throws ApiException {
		ApiResponse<PIDataServer> resp = getByNameWithHttpInfo(name, selectedFields);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PIDataServer> getByNameWithHttpInfo(String name, String selectedFields) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getByNameAsync(String name, String selectedFields, final ApiCallback<PIDataServer> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	 ...
	 *
	 */
	public PIDataServer getByPath(String path, String selectedFields) throws ApiException {
		ApiResponse<PIDataServer> resp = getByPathWithHttpInfo(path, selectedFields);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PIDataServer> getByPathWithHttpInfo(String path, String selectedFields) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getByPathAsync(String path, String selectedFields, final ApiCallback<PIDataServer> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	 ...
	 *
	 */
	public PIDataServer get(String webId, String selectedFields) throws ApiException {
		ApiResponse<PIDataServer> resp = getWithHttpInfo(webId, selectedFields);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PIDataServer> getWithHttpInfo(String webId, String selectedFields) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getAsync(String webId, String selectedFields, final ApiCallback<PIDataServer> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	 ...
	 *
	 */
	public PIItemsPoint getPoints(String webId, Integer maxCount, String nameFilter, String selectedFields, Integer startIndex) throws ApiException {
		ApiResponse<PIItemsPoint> resp = getPointsWithHttpInfo(webId, maxCount, nameFilter, selectedFields, startIndex);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PIItemsPoint> getPointsWithHttpInfo(String webId, Integer maxCount, String nameFilter, String selectedFields, Integer startIndex) throws ApiException {
		okhttp3.Call call = getPointsCall(webId, maxCount, nameFilter, selectedFields, startIndex,null,null);
	 ...
	 *
	 */
	public okhttp3.Call getPointsAsync(String webId, Integer maxCount, String nameFilter, String selectedFields, Integer startIndex, final ApiCallback<PIItemsPoint> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
		...
		okhttp3.Call call = getPointsCall(webId, maxCount, nameFilter, selectedFields, startIndex, progressListener, progressRequestListener);
		apiClient.executeAsync(call, callback);
		return call;
	}

	private okhttp3.Call getPointsCall(String webId, Integer maxCount, String nameFilter, String selectedFields, Integer startIndex, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		// verify the required parameter 'webId' is set
		if (webId == null)
			throw new ApiException("Missing required parameter 'webId'");
	 ...
	 *
	 */
	public void createPoint(String webId, PIPoint pointDTO) throws ApiException {
		createPointWithHttpInfo(webId, pointDTO);
	}
	 ...
	 *
	 */
	public ApiResponse<Void> createPointWithHttpInfo(String webId, PIPoint pointDTO) throws ApiException {
		okhttp3.Call call = createPointCall(webId, pointDTO,null,null);
		return apiClient.execute(call);
	}
	 ...
	 *
	 */
	public okhttp3.Call createPointAsync(String webId, PIPoint pointDTO, final ApiCallback<Void> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
		...
		okhttp3.Call call = createPointCall(webId, pointDTO, progressListener, progressRequestListener);
		apiClient.executeAsync(call, callback);
		return call;
	}

	private okhttp3.Call createPointCall(String webId, PIPoint pointDTO, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		// verify the required parameter 'webId' is set
		if (webId == null)
			throw new ApiException("Missing required parameter 'webId'");
