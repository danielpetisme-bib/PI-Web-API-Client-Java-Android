...
public class ElementTemplateApi {
	 ...
	 *
	 */
	public void update(String webId, PIElementTemplate template) throws ApiException {
		updateWithHttpInfo(webId, template);
	}

	/**
	 * Update an element template by replacing items in its definition. (with HTTP information)
	 *
	 */
	public ApiResponse<Void> updateWithHttpInfo(String webId, PIElementTemplate template) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call updateAsync(String webId, PIElementTemplate template, final ApiCallback<Void> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	...
	private okhttp3.Call updateCall(String webId, PIElementTemplate template, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		// verify the required parameter 'webId' is set
		if (webId == null)
			throw new ApiException("Missing required parameter 'webId'");
	...
	/**
	 * Delete an element template. (with HTTP information)
	 *
	 */
	...
	/**
	 * Update a security entry owned by the element template. (with HTTP information)
	 *
	 */
	...
	/**
	 * Delete a security entry owned by the element template. (with HTTP information)
	 *
	 */
