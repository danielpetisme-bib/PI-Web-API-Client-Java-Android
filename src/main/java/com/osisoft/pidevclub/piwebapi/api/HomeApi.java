...
public class HomeApi {
	 ...
	 *
	 */
	public PILanding get() throws ApiException {
		ApiResponse<PILanding> resp = getWithHttpInfo();
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PILanding> getWithHttpInfo() throws ApiException {
		okhttp3.Call call = getCall(null,null);
		Type localVarReturnType = new TypeToken<PILanding>(){}.getType();
	 ...
	 *
	 */
	public okhttp3.Call getAsync(final ApiCallback<PILanding> callback) throws ApiException {
