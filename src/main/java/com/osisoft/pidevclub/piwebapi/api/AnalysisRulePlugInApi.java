...
public class AnalysisRulePlugInApi {
	 ...
	 *
	 */
	public PIAnalysisRulePlugIn getByPath(String path, String selectedFields) throws ApiException {
		ApiResponse<PIAnalysisRulePlugIn> resp = getByPathWithHttpInfo(path, selectedFields);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PIAnalysisRulePlugIn> getByPathWithHttpInfo(String path, String selectedFields) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getByPathAsync(String path, String selectedFields, final ApiCallback<PIAnalysisRulePlugIn> callback) throws ApiException {
	 ...
	 *
	 */
	public PIAnalysisRulePlugIn get(String webId, String selectedFields) throws ApiException {
		ApiResponse<PIAnalysisRulePlugIn> resp = getWithHttpInfo(webId, selectedFields);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PIAnalysisRulePlugIn> getWithHttpInfo(String webId, String selectedFields) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getAsync(String webId, String selectedFields, final ApiCallback<PIAnalysisRulePlugIn> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
