...
public class AnalysisApi {
	 ...
	 *
	 */
	public void update(String webId, PIAnalysis analysis) throws ApiException {
		updateWithHttpInfo(webId, analysis);
	}

	/**
	 * Update an Analysis. (with HTTP information)
	 *
	 */
	public ApiResponse<Void> updateWithHttpInfo(String webId, PIAnalysis analysis) throws ApiException {
		okhttp3.Call call = updateCall(webId, analysis,null,null);
	 ...
	 *
	 */
	public okhttp3.Call updateAsync(String webId, PIAnalysis analysis, final ApiCallback<Void> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
		...
		okhttp3.Call call = updateCall(webId, analysis, progressListener, progressRequestListener);
		apiClient.executeAsync(call, callback);
		return call;
	}

	private okhttp3.Call updateCall(String webId, PIAnalysis analysis, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		// verify the required parameter 'webId' is set
		if (webId == null)
			throw new ApiException("Missing required parameter 'webId'");
	...
	/**
	 * Delete an Analysis. (with HTTP information)
	 *
	 */
	...
	/**
	 * Update a security entry owned by the analysis. (with HTTP information)
	 *
	 */
	...
	/**
	 * Delete a security entry owned by the analysis. (with HTTP information)
	 *
	 */
