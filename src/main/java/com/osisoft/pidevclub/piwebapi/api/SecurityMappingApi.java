...
public class SecurityMappingApi {
	 ...
	 *
	 */
	public PISecurityMapping getByPath(String path, String selectedFields) throws ApiException {
		ApiResponse<PISecurityMapping> resp = getByPathWithHttpInfo(path, selectedFields);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PISecurityMapping> getByPathWithHttpInfo(String path, String selectedFields) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getByPathAsync(String path, String selectedFields, final ApiCallback<PISecurityMapping> callback) throws ApiException {
	 ...
	 *
	 */
	public PISecurityMapping get(String webId, String selectedFields) throws ApiException {
		ApiResponse<PISecurityMapping> resp = getWithHttpInfo(webId, selectedFields);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PISecurityMapping> getWithHttpInfo(String webId, String selectedFields) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getAsync(String webId, String selectedFields, final ApiCallback<PISecurityMapping> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
