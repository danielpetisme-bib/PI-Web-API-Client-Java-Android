...
public class SecurityMappingApi {
	 ...
	 *
	 */
	public PISecurityMapping getByPath(String path, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PISecurityMapping> resp = getByPathWithHttpInfo(path, selectedFields, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve a security mapping by path. (with HTTP information)
	 *
	 */
	public ApiResponse<PISecurityMapping> getByPathWithHttpInfo(String path, String selectedFields, String webIdType) throws ApiException {
		okhttp3.Call call = getByPathCall(path, selectedFields, webIdType,null,null);
		Type localVarReturnType = new TypeToken<PISecurityMapping>(){}.getType();
	 ...
	 *
	 */
	public okhttp3.Call getByPathAsync(String path, String selectedFields, String webIdType, final ApiCallback<PISecurityMapping> callback) throws ApiException {
	 ...
	 *
	 */
	public PISecurityMapping get(String webId, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PISecurityMapping> resp = getWithHttpInfo(webId, selectedFields, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve a security mapping. (with HTTP information)
	 *
	 */
	public ApiResponse<PISecurityMapping> getWithHttpInfo(String webId, String selectedFields, String webIdType) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getAsync(String webId, String selectedFields, String webIdType, final ApiCallback<PISecurityMapping> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	 ...
	 *
	 */
	public void update(String webId, PISecurityMapping securityMapping) throws ApiException {
		updateWithHttpInfo(webId, securityMapping);
	}

	/**
	 * Update a security mapping by replacing items in its definition. (with HTTP information)
	 *
	 */
	public ApiResponse<Void> updateWithHttpInfo(String webId, PISecurityMapping securityMapping) throws ApiException {
		okhttp3.Call call = updateCall(webId, securityMapping,null,null);
	 ...
	 *
	 */
	public okhttp3.Call updateAsync(String webId, PISecurityMapping securityMapping, final ApiCallback<Void> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
		...
		okhttp3.Call call = updateCall(webId, securityMapping, progressListener, progressRequestListener);
		apiClient.executeAsync(call, callback);
		return call;
	}

	private okhttp3.Call updateCall(String webId, PISecurityMapping securityMapping, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		// verify the required parameter 'webId' is set
		if (webId == null)
			throw new ApiException("Missing required parameter 'webId'");
	...
	/**
	 * Delete a security mapping. (with HTTP information)
	 *
	 */
	...
	/**
	 * Get the security information of the specified security item associated with the security mapping for a specified user. (with HTTP information)
	 *
	 */
	...
	/**
	 * Retrieve the security entries associated with the security mapping based on the specified criteria. By default, all security entries for this security mapping are returned. (with HTTP information)
	 *
	 */
	...
	/**
	 * Retrieve the security entry associated with the security mapping with the specified name. (with HTTP information)
	 *
	 */
