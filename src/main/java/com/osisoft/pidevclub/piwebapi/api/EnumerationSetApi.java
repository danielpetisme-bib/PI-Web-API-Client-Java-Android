...
public class EnumerationSetApi {
	 ...
	 *
	 */
	public PIEnumerationSet getByPath(String path, String selectedFields) throws ApiException {
		ApiResponse<PIEnumerationSet> resp = getByPathWithHttpInfo(path, selectedFields);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PIEnumerationSet> getByPathWithHttpInfo(String path, String selectedFields) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getByPathAsync(String path, String selectedFields, final ApiCallback<PIEnumerationSet> callback) throws ApiException {
	 ...
	 *
	 */
	public PIEnumerationSet get(String webId, String selectedFields) throws ApiException {
		ApiResponse<PIEnumerationSet> resp = getWithHttpInfo(webId, selectedFields);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PIEnumerationSet> getWithHttpInfo(String webId, String selectedFields) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getAsync(String webId, String selectedFields, final ApiCallback<PIEnumerationSet> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	 ...
	 *
	 */
	public PIItemsEnumerationValue getValues(String webId, String selectedFields) throws ApiException {
		ApiResponse<PIItemsEnumerationValue> resp = getValuesWithHttpInfo(webId, selectedFields);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PIItemsEnumerationValue> getValuesWithHttpInfo(String webId, String selectedFields) throws ApiException {
		okhttp3.Call call = getValuesCall(webId, selectedFields,null,null);
	 ...
	 *
	 */
	public okhttp3.Call getValuesAsync(String webId, String selectedFields, final ApiCallback<PIItemsEnumerationValue> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
		...
		okhttp3.Call call = getValuesCall(webId, selectedFields, progressListener, progressRequestListener);
		apiClient.executeAsync(call, callback);
		return call;
	}

	private okhttp3.Call getValuesCall(String webId, String selectedFields, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		// verify the required parameter 'webId' is set
		if (webId == null)
			throw new ApiException("Missing required parameter 'webId'");
	 ...
	 *
	 */
	public void createValue(String webId, PIEnumerationValue enumerationValue) throws ApiException {
		createValueWithHttpInfo(webId, enumerationValue);
	}
	 ...
	 *
	 */
	public ApiResponse<Void> createValueWithHttpInfo(String webId, PIEnumerationValue enumerationValue) throws ApiException {
		okhttp3.Call call = createValueCall(webId, enumerationValue,null,null);
		return apiClient.execute(call);
	}
	 ...
	 *
	 */
	public okhttp3.Call createValueAsync(String webId, PIEnumerationValue enumerationValue, final ApiCallback<Void> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
		...
		okhttp3.Call call = createValueCall(webId, enumerationValue, progressListener, progressRequestListener);
		apiClient.executeAsync(call, callback);
		return call;
	}

	private okhttp3.Call createValueCall(String webId, PIEnumerationValue enumerationValue, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		// verify the required parameter 'webId' is set
		if (webId == null)
			throw new ApiException("Missing required parameter 'webId'");
