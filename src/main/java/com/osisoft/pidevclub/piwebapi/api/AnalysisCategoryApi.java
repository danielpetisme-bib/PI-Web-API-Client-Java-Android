...
public class AnalysisCategoryApi {
	 ...
	 *
	 */
	public PIAnalysisCategory getByPath(String path, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PIAnalysisCategory> resp = getByPathWithHttpInfo(path, selectedFields, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve an analysis category by path. (with HTTP information)
	 *
	 */
	public ApiResponse<PIAnalysisCategory> getByPathWithHttpInfo(String path, String selectedFields, String webIdType) throws ApiException {
		okhttp3.Call call = getByPathCall(path, selectedFields, webIdType,null,null);
		Type localVarReturnType = new TypeToken<PIAnalysisCategory>(){}.getType();
	 ...
	 *
	 */
	public okhttp3.Call getByPathAsync(String path, String selectedFields, String webIdType, final ApiCallback<PIAnalysisCategory> callback) throws ApiException {
	 ...
	 *
	 */
	public PIAnalysisCategory get(String webId, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PIAnalysisCategory> resp = getWithHttpInfo(webId, selectedFields, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve an analysis category. (with HTTP information)
	 *
	 */
	public ApiResponse<PIAnalysisCategory> getWithHttpInfo(String webId, String selectedFields, String webIdType) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getAsync(String webId, String selectedFields, String webIdType, final ApiCallback<PIAnalysisCategory> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	 ...
	 *
	 */
	public void update(String webId, PIAnalysisCategory category) throws ApiException {
		updateWithHttpInfo(webId, category);
	}

	/**
	 * Update an analysis category by replacing items in its definition. (with HTTP information)
	 *
	 */
	public ApiResponse<Void> updateWithHttpInfo(String webId, PIAnalysisCategory category) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call updateAsync(String webId, PIAnalysisCategory category, final ApiCallback<Void> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	...
	private okhttp3.Call updateCall(String webId, PIAnalysisCategory category, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		// verify the required parameter 'webId' is set
		if (webId == null)
			throw new ApiException("Missing required parameter 'webId'");
	...
	/**
	 * Delete an analysis category. (with HTTP information)
	 *
	 */
	...
	/**
	 * Get the security information of the specified security item associated with the analysis category for a specified user. (with HTTP information)
	 *
	 */
	...
	/**
	 * Retrieve the security entries associated with the analysis category based on the specified criteria. By default, all security entries for this analysis category are returned. (with HTTP information)
	 *
	 */
	...
	/**
	 * Create a security entry owned by the analysis category. (with HTTP information)
	 *
	 */
	...
	/**
	 * Retrieve the security entry associated with the analysis category with the specified name. (with HTTP information)
	 *
	 */
	...
	/**
	 * Update a security entry owned by the analysis category. (with HTTP information)
	 *
	 */
	...
	/**
	 * Delete a security entry owned by the analysis category. (with HTTP information)
	 *
	 */
