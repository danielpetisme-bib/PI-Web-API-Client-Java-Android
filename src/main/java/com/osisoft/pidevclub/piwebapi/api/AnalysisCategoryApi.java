...
public class AnalysisCategoryApi {
	 ...
	 *
	 */
	public PIAnalysisCategory getByPath(String path, String selectedFields) throws ApiException {
		ApiResponse<PIAnalysisCategory> resp = getByPathWithHttpInfo(path, selectedFields);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PIAnalysisCategory> getByPathWithHttpInfo(String path, String selectedFields) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getByPathAsync(String path, String selectedFields, final ApiCallback<PIAnalysisCategory> callback) throws ApiException {
	 ...
	 *
	 */
	public PIAnalysisCategory get(String webId, String selectedFields) throws ApiException {
		ApiResponse<PIAnalysisCategory> resp = getWithHttpInfo(webId, selectedFields);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PIAnalysisCategory> getWithHttpInfo(String webId, String selectedFields) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getAsync(String webId, String selectedFields, final ApiCallback<PIAnalysisCategory> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
