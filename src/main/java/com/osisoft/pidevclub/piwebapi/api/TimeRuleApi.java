...
public class TimeRuleApi {
	 ...
	 *
	 */
	public PITimeRule getByPath(String path, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PITimeRule> resp = getByPathWithHttpInfo(path, selectedFields, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve a Time Rule by path. (with HTTP information)
	 *
	 */
	public ApiResponse<PITimeRule> getByPathWithHttpInfo(String path, String selectedFields, String webIdType) throws ApiException {
		okhttp3.Call call = getByPathCall(path, selectedFields, webIdType,null,null);
		Type localVarReturnType = new TypeToken<PITimeRule>(){}.getType();
	 ...
	 *
	 */
	public okhttp3.Call getByPathAsync(String path, String selectedFields, String webIdType, final ApiCallback<PITimeRule> callback) throws ApiException {
	 ...
	 *
	 */
	public PITimeRule get(String webId, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PITimeRule> resp = getWithHttpInfo(webId, selectedFields, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve a Time Rule. (with HTTP information)
	 *
	 */
	public ApiResponse<PITimeRule> getWithHttpInfo(String webId, String selectedFields, String webIdType) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getAsync(String webId, String selectedFields, String webIdType, final ApiCallback<PITimeRule> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	 ...
	 *
	 */
	public void update(String webId, PITimeRule timeRule) throws ApiException {
		updateWithHttpInfo(webId, timeRule);
	}

	/**
	 * Update a Time Rule by replacing items in its definition. (with HTTP information)
	 *
	 */
	public ApiResponse<Void> updateWithHttpInfo(String webId, PITimeRule timeRule) throws ApiException {
		okhttp3.Call call = updateCall(webId, timeRule,null,null);
	 ...
	 *
	 */
	public okhttp3.Call updateAsync(String webId, PITimeRule timeRule, final ApiCallback<Void> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
		...
		okhttp3.Call call = updateCall(webId, timeRule, progressListener, progressRequestListener);
		apiClient.executeAsync(call, callback);
		return call;
	}

	private okhttp3.Call updateCall(String webId, PITimeRule timeRule, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		// verify the required parameter 'webId' is set
		if (webId == null)
			throw new ApiException("Missing required parameter 'webId'");
		...
		if (timeRule == null)
			throw new ApiException("Missing required parameter 'timeRule'");
		String localVarPath = "/timerules/{webId}";
		Map<String, String> localVarHeaderParams = new HashMap<String, String>();
		Map<String, Object> localVarFormParams = new HashMap<String, Object>();
		List<Pair> localVarQueryParams = new ArrayList<Pair>();
	...
	/**
	 * Delete a Time Rule. (with HTTP information)
	 *
	 */
