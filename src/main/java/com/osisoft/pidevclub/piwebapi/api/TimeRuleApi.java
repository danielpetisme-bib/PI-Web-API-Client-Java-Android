...
public class TimeRuleApi {
	 ...
	 *
	 */
	public PITimeRule getByPath(String path, String selectedFields) throws ApiException {
		ApiResponse<PITimeRule> resp = getByPathWithHttpInfo(path, selectedFields);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PITimeRule> getByPathWithHttpInfo(String path, String selectedFields) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getByPathAsync(String path, String selectedFields, final ApiCallback<PITimeRule> callback) throws ApiException {
	 ...
	 *
	 */
	public PITimeRule get(String webId, String selectedFields) throws ApiException {
		ApiResponse<PITimeRule> resp = getWithHttpInfo(webId, selectedFields);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PITimeRule> getWithHttpInfo(String webId, String selectedFields) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getAsync(String webId, String selectedFields, final ApiCallback<PITimeRule> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
