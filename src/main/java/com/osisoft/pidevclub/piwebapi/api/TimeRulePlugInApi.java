...
public class TimeRulePlugInApi {
	 ...
	 *
	 */
	public PITimeRulePlugIn getByPath(String path, String selectedFields) throws ApiException {
		ApiResponse<PITimeRulePlugIn> resp = getByPathWithHttpInfo(path, selectedFields);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PITimeRulePlugIn> getByPathWithHttpInfo(String path, String selectedFields) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getByPathAsync(String path, String selectedFields, final ApiCallback<PITimeRulePlugIn> callback) throws ApiException {
	 ...
	 *
	 */
	public PITimeRulePlugIn get(String webId, String selectedFields) throws ApiException {
		ApiResponse<PITimeRulePlugIn> resp = getWithHttpInfo(webId, selectedFields);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PITimeRulePlugIn> getWithHttpInfo(String webId, String selectedFields) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getAsync(String webId, String selectedFields, final ApiCallback<PITimeRulePlugIn> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
