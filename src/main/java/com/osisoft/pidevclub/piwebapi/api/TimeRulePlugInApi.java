...
public class TimeRulePlugInApi {
	 ...
	 *
	 */
	public PITimeRulePlugIn getByPath(String path, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PITimeRulePlugIn> resp = getByPathWithHttpInfo(path, selectedFields, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve a Time Rule Plug-in by path. (with HTTP information)
	 *
	 */
	public ApiResponse<PITimeRulePlugIn> getByPathWithHttpInfo(String path, String selectedFields, String webIdType) throws ApiException {
		okhttp3.Call call = getByPathCall(path, selectedFields, webIdType,null,null);
		Type localVarReturnType = new TypeToken<PITimeRulePlugIn>(){}.getType();
	 ...
	 *
	 */
	public okhttp3.Call getByPathAsync(String path, String selectedFields, String webIdType, final ApiCallback<PITimeRulePlugIn> callback) throws ApiException {
	 ...
	 *
	 */
	public PITimeRulePlugIn get(String webId, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PITimeRulePlugIn> resp = getWithHttpInfo(webId, selectedFields, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve a Time Rule Plug-in. (with HTTP information)
	 *
	 */
	public ApiResponse<PITimeRulePlugIn> getWithHttpInfo(String webId, String selectedFields, String webIdType) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getAsync(String webId, String selectedFields, String webIdType, final ApiCallback<PITimeRulePlugIn> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
