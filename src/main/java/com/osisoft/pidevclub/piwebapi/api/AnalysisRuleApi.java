...
public class AnalysisRuleApi {
	 ...
	 *
	 */
	public void update(String webId, PIAnalysisRule analysisRule) throws ApiException {
		updateWithHttpInfo(webId, analysisRule);
	}

	/**
	 * Update an Analysis Rule by replacing items in its definition. (with HTTP information)
	 *
	 */
	public ApiResponse<Void> updateWithHttpInfo(String webId, PIAnalysisRule analysisRule) throws ApiException {
		okhttp3.Call call = updateCall(webId, analysisRule,null,null);
	 ...
	 *
	 */
	public okhttp3.Call updateAsync(String webId, PIAnalysisRule analysisRule, final ApiCallback<Void> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
		...
		okhttp3.Call call = updateCall(webId, analysisRule, progressListener, progressRequestListener);
		apiClient.executeAsync(call, callback);
		return call;
	}

	private okhttp3.Call updateCall(String webId, PIAnalysisRule analysisRule, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		// verify the required parameter 'webId' is set
		if (webId == null)
			throw new ApiException("Missing required parameter 'webId'");
		...
		if (analysisRule == null)
			throw new ApiException("Missing required parameter 'analysisRule'");
		String localVarPath = "/analysisrules/{webId}";
		Map<String, String> localVarHeaderParams = new HashMap<String, String>();
		Map<String, Object> localVarFormParams = new HashMap<String, Object>();
		List<Pair> localVarQueryParams = new ArrayList<Pair>();
	...
	/**
	 * Delete an Analysis Rule. (with HTTP information)
	 *
	 */
