...
public class AttributeCategoryApi {
	 ...
	 *
	 */
	public PIAttributeCategory getByPath(String path, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PIAttributeCategory> resp = getByPathWithHttpInfo(path, selectedFields, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve an attribute category by path. (with HTTP information)
	 *
	 */
	public ApiResponse<PIAttributeCategory> getByPathWithHttpInfo(String path, String selectedFields, String webIdType) throws ApiException {
		okhttp3.Call call = getByPathCall(path, selectedFields, webIdType,null,null);
		Type localVarReturnType = new TypeToken<PIAttributeCategory>(){}.getType();
	 ...
	 *
	 */
	public okhttp3.Call getByPathAsync(String path, String selectedFields, String webIdType, final ApiCallback<PIAttributeCategory> callback) throws ApiException {
	 ...
	 *
	 */
	public PIAttributeCategory get(String webId, String selectedFields, String webIdType) throws ApiException {
		ApiResponse<PIAttributeCategory> resp = getWithHttpInfo(webId, selectedFields, webIdType);
		return resp.getData();
	}

	/**
	 * Retrieve an attribute category. (with HTTP information)
	 *
	 */
	public ApiResponse<PIAttributeCategory> getWithHttpInfo(String webId, String selectedFields, String webIdType) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getAsync(String webId, String selectedFields, String webIdType, final ApiCallback<PIAttributeCategory> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
	 ...
	 *
	 */
	public void update(String webId, PIAttributeCategory category) throws ApiException {
		updateWithHttpInfo(webId, category);
	}

	/**
	 * Update an attribute category by replacing items in its definition. (with HTTP information)
	 *
	 */
	public ApiResponse<Void> updateWithHttpInfo(String webId, PIAttributeCategory category) throws ApiException {
		okhttp3.Call call = updateCall(webId, category,null,null);
	 ...
	 *
	 */
	public okhttp3.Call updateAsync(String webId, PIAttributeCategory category, final ApiCallback<Void> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
		...
		okhttp3.Call call = updateCall(webId, category, progressListener, progressRequestListener);
		apiClient.executeAsync(call, callback);
		return call;
	}

	private okhttp3.Call updateCall(String webId, PIAttributeCategory category, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		Object localVarPostBody =  null;
		// verify the required parameter 'webId' is set
		if (webId == null)
			throw new ApiException("Missing required parameter 'webId'");
	...
	/**
	 * Delete an attribute category. (with HTTP information)
	 *
	 */
	...
	/**
	 * Get the security information of the specified security item associated with the attribute category for a specified user. (with HTTP information)
	 *
	 */
	...
	/**
	 * Retrieve the security entries associated with the attribute category based on the specified criteria. By default, all security entries for this attribute category are returned. (with HTTP information)
	 *
	 */
	...
	/**
	 * Create a security entry owned by the attribute category. (with HTTP information)
	 *
	 */
	...
	/**
	 * Retrieve the security entry associated with the attribute category with the specified name. (with HTTP information)
	 *
	 */
	...
	/**
	 * Update a security entry owned by the attribute category. (with HTTP information)
	 *
	 */
	...
	/**
	 * Delete a security entry owned by the attribute category. (with HTTP information)
	 *
	 */
