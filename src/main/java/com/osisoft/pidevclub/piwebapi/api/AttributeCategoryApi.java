...
public class AttributeCategoryApi {
	 ...
	 *
	 */
	public PIAttributeCategory getByPath(String path, String selectedFields) throws ApiException {
		ApiResponse<PIAttributeCategory> resp = getByPathWithHttpInfo(path, selectedFields);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PIAttributeCategory> getByPathWithHttpInfo(String path, String selectedFields) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getByPathAsync(String path, String selectedFields, final ApiCallback<PIAttributeCategory> callback) throws ApiException {
	 ...
	 *
	 */
	public PIAttributeCategory get(String webId, String selectedFields) throws ApiException {
		ApiResponse<PIAttributeCategory> resp = getWithHttpInfo(webId, selectedFields);
		return resp.getData();
	}
	 ...
	 *
	 */
	public ApiResponse<PIAttributeCategory> getWithHttpInfo(String webId, String selectedFields) throws ApiException {
	 ...
	 *
	 */
	public okhttp3.Call getAsync(String webId, String selectedFields, final ApiCallback<PIAttributeCategory> callback) throws ApiException {
		ProgressResponseBody.ProgressListener progressListener = null;
		ProgressRequestBody.ProgressRequestListener progressRequestListener = null;
		if (callback != null)
		{
